(function() {
  ...
  // --- Р¤СѓРЅРєС†РёСЏ РґРёРЅР°РјРёС‡РµСЃРєРѕРіРѕ РІС‹Р±РѕСЂР° СЃРµСЂРІРµСЂР° (50/50) ---
  ...
  // РСЃРїРѕР»СЊР·СѓРµРј РґРµС„РѕР»С‚РЅС‹Р№ С…РѕСЃС‚ РґР»СЏ РёРЅРёС†РёР°Р»РёР·Р°С†РёРё, РЅРѕ РѕРЅ Р±СѓРґРµС‚ РїРѕРґРјРµРЅСЏС‚СЊСЃСЏ РІ Р·Р°РїСЂРѕСЃР°С…
...
var hostkey = 'hdpoisk.ru:2053'; // РСЃРїРѕР»СЊР·СѓРµРј РїРѕСЃС‚РѕСЏРЅРЅС‹Р№ РєР»СЋС‡ РґР»СЏ С…СЂР°РЅРёР»РёС‰Р°, С‡С‚РѕР±С‹ РЅРµ С‚РµСЂСЏС‚СЊ СЃРµСЃСЃРёСЋ
...
window.rch_nws[hostkey].typeInvoke = function rchtypeInvoke(host, call) {
  if (!window.rch_nws[hostkey].startTypeInvoke) {
    ...
    if (Lampa.Platform.is('android') || Lampa.Platform.is('tizen')) check(true);
      ...
      // РўСѓС‚ С‚РѕР¶Рµ РёСЃРїРѕР»СЊР·СѓРµРј РґРёРЅР°РјРёС‡РµСЃРєРёР№ С…РѕСЃС‚ РґР»СЏ РїСЂРѕРІРµСЂРєРё
...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  // Р’С‹Р·С‹РІР°РµРј СЃ РґРёРЅР°РјРёС‡РµСЃРєРёРј С…РѕСЃС‚РѕРј
          ...
          new Response(compressedStream).arrayBuffer()
            .then(function(compressedBuffer) {
              ...
              if (compressedArray.length > html.length) {
                ...
                $.ajax({
                  // РСЃРїРѕР»СЊР·СѓРµРј РґРёРЅР°РјРёС‡РµСЃРєРёР№ С…РѕСЃС‚ РґР»СЏ POST СЂРµР·СѓР»СЊС‚Р°С‚Р°
  ...
  function rchRun(json, call) {
    if (typeof NativeWsClient == 'undefined') {
      // РСЃРїРѕР»СЊР·СѓРµРј РґРёРЅР°РјРёС‡РµСЃРєРёР№ С…РѕСЃС‚ РґР»СЏ Р·Р°РіСЂСѓР·РєРё СЃРєСЂРёРїС‚Р° РєР»РёРµРЅС‚Р°
  ...
  function account(url) {
    ...
    // --- Р”РРќРђРњРР§Р•РЎРљРђРЇ РџРћР”РњР•РќРђ РҐРћРЎРўРђ ---
    // РџСЂРё РєР°Р¶РґРѕРј РІС‹Р·РѕРІРµ account, РјС‹ Р±РµСЂРµРј РЅРѕРІС‹Р№ СЃР»СѓС‡Р°Р№РЅС‹Р№ СЃРµСЂРІРµСЂ
    // Рё Р·Р°РјРµРЅСЏРµРј Р»СЋР±С‹Рµ РёР·РІРµСЃС‚РЅС‹Рµ РґРѕРјРµРЅС‹ РЅР° РЅРµРіРѕ.
    var random_host = getBalancerUrl();
    
    // РЎРїРёСЃРѕРє РґРѕРјРµРЅРѕРІ, РєРѕС‚РѕСЂС‹Рµ РјС‹ С…РѕС‚РёРј РїРѕРґРјРµРЅСЏС‚СЊ РЅР° Р»РµС‚Сѓ
    var replaceable = [
        'http://hdpoisk.ru:2053',
        'http://hdpoisk.ru:2053',
        'http://arkmv.ru:2053'
    ...
    for (var i = 0; i < replaceable.length; i++) {
        if (url.indexOf(replaceable[i]) !== -1) {
            ...
            break; // Р—Р°РјРµРЅРёР»Рё РѕРґРёРЅ СЂР°Р· Рё РІС‹С…РѕРґРёРј
        }
    }
    // ----------------------------------
  ...
  function startPlugin() {
    ...
    Lampa.Lang.add({
      ...
      lampac_balanser: { //
        ru: 'вљЎРСЃС‚РѕС‡РЅРёРє',
        uk: 'вљЎР”Р¶РµСЂРµР»Рѕ',
        en: 'вљЎSource',
        zh: '??'
      },
      helper_online_file: { //
    ...
    Lampa.Component.add('vod', component); //С‚Рѕ Р¶Рµ СЃР°РјРѕРµ
    resetTemplates();
...
var donate=$('<div class="Message" style="line-height: 0.5;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;"><div class="ad-server__text">РЎРїР°СЃРёР±Рѕ РІСЃРµРј, РєС‚Рѕ СѓР¶Рµ РїРѕРґРґРµСЂР¶Р°Р» Рё РїРѕРґРґРµСЂР¶РёРІР°РµС‚ вќ¤пёЏ<br>РЎ Р»СЋР±РѕР№ РєР°СЂС‚С‹ С‡РµСЂРµР· DONATIONALERTS РїРѕ QR:</br></div><img src="http://arkmv.ru/msx/don.png" class="ad-server__qr"></div>');Lampa.Storage.listener.follow("change",function(e){if("activity"==e.name&&"vod"==Lampa.Activity.active().component)var t=setInterval(function(){null!==document.querySelector(".online-prestige-watched")&&($(".online-prestige-watched").after(donate),clearInterval(t))},50)});
